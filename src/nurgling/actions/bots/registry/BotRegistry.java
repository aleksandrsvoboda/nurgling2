...
public class BotRegistry {
    ...
    static {
        ...
        bots.add(new BotDescriptor("tickbot", BotDescriptor.BotType.RESOURCES, "Tick Bot", "Stands in thicket area to gather ticks. Drops off to PUT area when inventory full. Stops if HP falls below 50%.", true, true, TickBot.class, "test35", false));
