...
public class BuildTtub implements Action {
    ...
    public Results run(NGameUI gui) throws InterruptedException {
        try {
            ...
            SelectAreaWithLiveGhosts buildarea = new SelectAreaWithLiveGhosts(context, Resource.loadsimg("baubles/buildArea"), "Tanning Tub");
            ...
            command.ingredients.add(helper.getBlocks(2));
