...
public class FarmingSettingsPanel extends Panel {
    ...
    private CheckBox skipButcherInDucksCheck;
    private CheckBox skipPluckingDrakesInDucksCheck;
    ...
    public FarmingSettingsPanel() {
        ...
        skipButcherInDucksCheck = new CheckBox(L10n.get("farming.skip_butcher_ducks")) {
            public void set(boolean val) {
                a = val;
            }
        };

        add(skipButcherInDucksCheck, new Coord(margin, y));
        y += UI.scale(28);

        skipPluckingDrakesInDucksCheck = new CheckBox(L10n.get("farming.skip_pluck_drakes_ducks")) {
            public void set(boolean val) {
                a = val;
            }
        };

        add(skipPluckingDrakesInDucksCheck, new Coord(margin, y));
        y += UI.scale(28);
    ...
    public void load() {
        ...
        Boolean skipButcherDucks = (Boolean) NConfig.get(NConfig.Key.skipButcherInDucks);
        skipButcherInDucksCheck.a = skipButcherDucks != null && skipButcherDucks;

        Boolean skipPluckDrakes = (Boolean) NConfig.get(NConfig.Key.skipPluckingDrakesInDucks);
        skipPluckingDrakesInDucksCheck.a = skipPluckDrakes != null && skipPluckDrakes;
    ...
    public void save() {
        ...
        NConfig.set(NConfig.Key.skipButcherInDucks, skipButcherInDucksCheck.a);
        NConfig.set(NConfig.Key.skipPluckingDrakesInDucks, skipPluckingDrakesInDucksCheck.a);
