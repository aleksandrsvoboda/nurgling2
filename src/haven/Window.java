...
//			NUtils.getUI().core.resetTasks();
	...
	public static final Text.Forge cf  = new Text.Foundry(nurgling.conf.FontSettings.getOpenSansSemibold(), 11, new Color(255, 255, 255)).aa(true);
	public static final Text.Forge ncf = new Text.Foundry(nurgling.conf.FontSettings.getOpenSansSemibold(), 11, new Color(160, 160, 160)).aa(true);
