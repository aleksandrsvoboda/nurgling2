...
public class GoatRoster extends CattleRoster<Goat> {
	...
	new Column<Goat>(Resource.classres(GoatRoster.class).pool.load("gfx/hud/rosters/woolquantity", 1), Comparator.comparing((Goat e) -> e.wool).reversed()),
    ...
    protected List<Column<? super Goat>> cols() {return(cols);}
